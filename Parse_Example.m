...
behavioral_file='Sub01_DD_04192017_OR_HandL_STNR_Block04.mat';
%% Load Data
...
spikes=load_spikes(file,alg);%give the file, and then say what algorithm you used to get the spikes.
